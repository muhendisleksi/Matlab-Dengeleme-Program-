...
% Last Modified by GUIDE v2.5 29-Jun-2018 18:41:28
...
if knan ~= 0
    if ch == 1
        ...
        for i = 1:elips_say/2
            ...
            A(i,1) = so*abs(sqrt(lamda1(i))); %%%%%%%%%%%%%%%% irrasyonel geliyorr????
        ...
        for i = 1:elips_say/2
              x0= KoorX(i);
              y0 = KoorY(i);
              x1 = x0 + A(i)*cos(tetha(i)) ;
              y1 =  y0 + A(i)*sin(tetha(i))  ;
